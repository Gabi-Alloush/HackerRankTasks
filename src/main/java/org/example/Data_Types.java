...
/**
 ...
 Reference: docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes

 Input Format:
 The first line contains an integer, T, denoting the number of test cases.
 Each test case, T, comprised of a single line with an integer, n, which can be arbitrarily large or small.
